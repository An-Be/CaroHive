...
export const Navbar = () => {
  ...
  return (
    <div className="Navbar navbar" style={{backgroundColor: 'transparent'}}>
      ...
      <div className="Navbar__bottom">
        ...
        />
        <motion.div whileHover={{ scale: 1.3 }} whileTap={{ scale: 0.9 }} className="Navbar__bottom__cart">
        ...
        <Link className="Navbar__bottom__login" to="/login">
          <motion.div whileHover={{ scale: 1.3 }} whileTap={{ scale: 0.9 }}><IoMdLogIn /></motion.div>
        </Link>
      </div>
    </div>
  );
